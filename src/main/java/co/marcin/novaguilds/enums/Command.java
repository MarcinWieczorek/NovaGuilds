...
public final class Command extends CommandWrapperImpl {
	public static final CommandWrapper ADMIN_ACCESS =                         new Command(CommandAdmin.class,                               Permission.NOVAGUILDS_ADMIN_ACCESS,                        "nga",        Message.CHAT_USAGE_NGA_ACCESS,             new TabCompleterAdmin()                              );
...
//	public static final CommandWrapper ADMIN_HOLOGRAM_ADD =                   new Command(null,                                             Permission.NOVAGUILDS_ADMIN_HOLOGRAM_ADD,                                Message.CHAT_USAGE_NGA_ADD,                                         Flag.NOCONSOLE              );
	...
	public static final CommandWrapper GUILD_ACCESS =                         new Command(CommandGuild.class,                               Permission.NOVAGUILDS_GUILD_ACCESS,                        "guild",      Message.CHAT_USAGE_GUILD_ACCESS,           new TabCompleterGuild()                              );

...
public final class Command extends CommandWrapperImpl {
	...
	public static final CommandWrapper ADMIN_CHATSPY =                        new Command(CommandAdminChatSpy.class,                        Permission.NOVAGUILDS_ADMIN_CHATSPY_SELF,                                                                                                                  Flag.NOCONSOLE);
	...
	public static final CommandWrapper ADMIN_GUILD_ACCESS =                   new Command(CommandAdminGuild.class,                          Permission.NOVAGUILDS_ADMIN_GUILD_ACCESS                                                                                                                                 );
	...
	public static final CommandWrapper ADMIN_GUILD_BANK_PAY =                 new Command(CommandAdminGuildBankPay.class,                   Permission.NOVAGUILDS_ADMIN_GUILD_BANK_PAY                                                                                                                               );
	public static final CommandWrapper ADMIN_GUILD_BANK_WITHDRAW =            new Command(CommandAdminGuildBankWithdraw.class,              Permission.NOVAGUILDS_ADMIN_GUILD_BANK_WITHDRAW                                                                                                                          );
	public static final CommandWrapper ADMIN_GUILD_INACTIVE =                 new Command(CommandAdminGuildInactive.class,                  Permission.NOVAGUILDS_ADMIN_GUILD_INACTIVE_LIST                                                                                                                          );
	public static final CommandWrapper ADMIN_GUILD_INVITE =                   new Command(CommandAdminGuildInvite.class,                    Permission.NOVAGUILDS_ADMIN_GUILD_INVITE                                                                                                                                 );
	public static final CommandWrapper ADMIN_GUILD_KICK =                     new Command(CommandAdminGuildKick.class,                      Permission.NOVAGUILDS_ADMIN_GUILD_KICK                                                                                                                                   );
	public static final CommandWrapper ADMIN_GUILD_LIST =                     new Command(CommandAdminGuildList.class,                      Permission.NOVAGUILDS_ADMIN_GUILD_LIST                                                                                                                                   );
	public static final CommandWrapper ADMIN_GUILD_SET_LEADER =               new Command(CommandAdminGuildSetLeader.class,                 Permission.NOVAGUILDS_ADMIN_GUILD_SET_LEADER                                                                                                                             );
	public static final CommandWrapper ADMIN_GUILD_SET_LIVEREGENERATIONTIME = new Command(CommandAdminGuildSetLiveRegenerationTime.class,   Permission.NOVAGUILDS_ADMIN_GUILD_SET_LIVEREGENERATIONTIME                                                                                                               );
	public static final CommandWrapper ADMIN_GUILD_SET_LIVES =                new Command(CommandAdminGuildSetLives.class,                  Permission.NOVAGUILDS_ADMIN_GUILD_SET_LIVES                                                                                                                              );
	public static final CommandWrapper ADMIN_GUILD_SET_NAME =                 new Command(CommandAdminGuildSetName.class,                   Permission.NOVAGUILDS_ADMIN_GUILD_SET_NAME                                                                                                                               );
	public static final CommandWrapper ADMIN_GUILD_SET_POINTS =               new Command(CommandAdminGuildSetPoints.class,                 Permission.NOVAGUILDS_ADMIN_GUILD_SET_POINTS                                                                                                                             );
	public static final CommandWrapper ADMIN_GUILD_SET_TAG =                  new Command(CommandAdminGuildSetTag.class,                    Permission.NOVAGUILDS_ADMIN_GUILD_SET_TAG                                                                                                                                );
	public static final CommandWrapper ADMIN_GUILD_SET_TIMEREST =             new Command(CommandAdminGuildSetTimerest.class,               Permission.NOVAGUILDS_ADMIN_GUILD_SET_TIMEREST                                                                                                                           );
	public static final CommandWrapper ADMIN_GUILD_SET_SLOTS =                new Command(CommandAdminGuildSetSlots.class,                  Permission.NOVAGUILDS_ADMIN_GUILD_SET_SLOTS                                                                                                                              );
	...
	public static final CommandWrapper ADMIN_GUILD_RANK_ACCESS =              new Command(CommandAdminGuildRank.class,                      Permission.NOVAGUILDS_ADMIN_GUILD_RANK_ACCESS                                                                                                                            );
	public static final CommandWrapper ADMIN_GUILD_RANK_DELETE =              new Command(CommandAdminGuildRankDelete.class,                Permission.NOVAGUILDS_ADMIN_GUILD_RANK_DELETE                                                                                                                            );
	public static final CommandWrapper ADMIN_GUILD_RANK_LIST =                new Command(CommandAdminGuildRankList.class,                  Permission.NOVAGUILDS_ADMIN_GUILD_RANK_LIST                                                                                                                              );
	public static final CommandWrapper ADMIN_HOLOGRAM_ACCESS =                new Command(CommandAdminHologram.class,                       Permission.NOVAGUILDS_ADMIN_HOLOGRAM_ACCESS                                                                                                                              );
	public static final CommandWrapper ADMIN_HOLOGRAM_LIST =                  new Command(CommandAdminHologramList.class,                   Permission.NOVAGUILDS_ADMIN_HOLOGRAM_LIST                                                                                                                                );
	public static final CommandWrapper ADMIN_HOLOGRAM_TELEPORT =              new Command(CommandAdminHologramTeleport.class,               Permission.NOVAGUILDS_ADMIN_HOLOGRAM_TELEPORT,                                                                                               Flag.NOCONSOLE              );
	public static final CommandWrapper ADMIN_HOLOGRAM_DELETE =                new Command(CommandAdminHologramDelete.class,                 Permission.NOVAGUILDS_ADMIN_HOLOGRAM_DELETE                                                                                                                              );
	public static final CommandWrapper ADMIN_HOLOGRAM_ADDTOP =                new Command(CommandAdminHologramAddTop.class,                 Permission.NOVAGUILDS_ADMIN_HOLOGRAM_ADDTOP,                                                                                                 Flag.NOCONSOLE              );
//	public static final CommandWrapper ADMIN_HOLOGRAM_ADD =                   new Command(null,                                             Permission.NOVAGUILDS_ADMIN_HOLOGRAM_ADD,                                                                                                    Flag.NOCONSOLE              );
	public static final CommandWrapper ADMIN_HOLOGRAM_TELEPORT_HERE =         new Command(CommandAdminHologramTeleportHere.class,           Permission.NOVAGUILDS_ADMIN_HOLOGRAM_TELEPORT_HERE,                                                                                          Flag.NOCONSOLE              );
	public static final CommandWrapper GUILD_ACCESS =                         new Command(CommandGuild.class,                               Permission.NOVAGUILDS_GUILD_ACCESS,                        "guild",                                                 new TabCompleterGuild()                              );
...
//	public static final CommandWrapper GUILD_BOSS =                           new Command(null,                                             Permission.NOVAGUILDS_GUILD_BOSS,                                                                                                            Flag.NOCONSOLE              );
	...
	public static final CommandWrapper GUILD_INFO =                           new Command(CommandGuildInfo.class,                           Permission.NOVAGUILDS_GUILD_INFO,                          "gi",         Message.CHAT_USAGE_GUILD_INFO,             new TabCompleterGuild()                              );
	...
	public static final CommandWrapper GUILD_RANK_ACCESS =                    new Command(CommandGuildRank.class,                           Permission.NOVAGUILDS_GUILD_RANK_ACCESS,                                                                                                     Flag.NOCONSOLE              );
	public static final CommandWrapper GUILD_RANK_DELETE =                    new Command(CommandGuildRankDelete.class,                     Permission.NOVAGUILDS_GUILD_RANK_DELETE,                                                                                                     Flag.NOCONSOLE              );
	public static final CommandWrapper GUILD_RANK_LIST =                      new Command(CommandGuildRankList.class,                       Permission.NOVAGUILDS_GUILD_RANK_LIST,                                                                                                       Flag.NOCONSOLE              );
	...
	public static final CommandWrapper TOOL_GET =                             new Command(CommandToolGet.class,                             Permission.NOVAGUILDS_TOOL_GET,                                                                                                              Flag.NOCONSOLE              );
	public static final CommandWrapper PLAYERINFO =                           new Command(CommandPlayerInfo.class,                          Permission.NOVAGUILDS_PLAYERINFO,                          "playerinfo"                                                                                                  );
	...
	public static final CommandWrapper CONFIRM =                              new Command(CommandConfirm.class,                             Permission.NOVAGUILDS_CONFIRM,                             "confirm"                                                                                                     );
